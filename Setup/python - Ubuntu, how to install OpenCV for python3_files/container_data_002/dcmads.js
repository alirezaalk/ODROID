...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.130.js"},
		protocol: 'https',
		jsref: "",
		asid: "6ef2b3d0-f8c0-11ea-8144-0a1e87f1382c",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=457090",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/www.googletagservices.com\/457090\/46650810\/dcm\/dcmads.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/www.googletagservices.com\/457090\/46650810\/dcm\/dcmads.js",
		accountForSadImps: '',
		sendCookie: 'true',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=457090&pubEnt=46650810',
		fwMonitoring: 'false',
		doNothing: false,
		mn: "app12ie",
		mobOrTab: false,
		app: false,
		mobAppWebview: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/blocking\/app\/initial\/457090\/46650810?redirectUrl=https%3A%2F%2Fwww.googletagservices.com%2Fdcm%2Fdcmads.js",
		anId: '',
		advEntityId: '457090',
		pubEntityId: '46650810',
		videoId: '',
		videoChannel: '',
		rts: {},
		customViewability: [],
...
A.trigger("requestBootstrapper",a)});A.once("requestBootstrapper",function(a){var b=l.forcedBootstrapperHost||"https://jsconfig.adsafeprotected.com";if("string"===typeof a)try{a=JSON.parse(a)}catch(c){}var r=a&&a.config,n=a&&a.sca,q=a&&a.xsca;r&&A.trigger("jsonp",b+"/jsconfig"+r+(l.adSessionId?"&adSessionId="+l.adSessionId:""),function(a){a="string"===typeof a?JSON.parse(a):a;if(Object.assign)Object.assign(l,a);else for(var b in a)l[b]=a[b];l.isResolved=!0;l.sp_cdnScripts={sca:n,xsca:q};A.trigger("callContinueMain")},
...
"found");break}}catch(h){}g.contextNode=d}}}},ac=function(){var g,a=["STYLE","SCRIPT","HEAD","META"],b=k.RENDER.CREATIVE_NODE_TYPES.concat(k.RENDER.CONTAINER_NODE_TYPES),c=0,d=l.useFIF&&u.friendlyIframe||u.isSpecifiedAd(),e=function(e){var r=t.isNodeXDomainIframe(e)||t.isNodeCreative(e),n=!e;g=n?l.contextNode.parentNode:e;if(r||n)m.getAggregator().trigger("evaluateCreativeFinderResult",e);else{if(d){var q;q=r=e;n=u.friendly?p.getTop().document.body:l.contextNode.ownerDocument.body;for(;3>c;){if(n&&
r===n){q=r;c=3;break}t.isWindow(r)&&(q=t.crossQuerySelector("["+k.AD_IDENTIFIER+"-"+l.asid+"]"),r=f.isDef(q)?q:r);q=r=f.isDef(r)?r.parentNode||r:r;c++}r=q}else r=e;if(t.isWindow(r)){var s;try{s=r.document}catch(z){s=l.contextNode.ownerDocument}e=s}else e="IFRAME"===t.getNodeName(r)?e.contentWindow.document:r;s=[];var n=(r=e&&e.getElementsByTagName&&e.getElementsByTagName("*"))&&r.length,B;if(r)for(var w=0;w<n;w++)B=(q=r[w])&&q.nodeName&&q.nodeName.toUpperCase(),!q.children||0!==q.children.length||
f(b).contains(B)||f(a).contains(B)||f(s).contains(B)||s.push(B);s=b.concat(s);(new $b(s)).searchDescendants(e)}};m.getAggregator().on("creativeFinderBatchCompleted",e);return{find:e,getClosestContainerName:function(){return t.getNodeName(g)}}},$b=function(g){var a=function(a){function c(a){var b=t.getNodeName(a),c=t.isNodeCreative(a)||"IFRAME"===b;b&&c&&!t.isEmptyTeadsFrame(a)&&(b=t.getNodeArea(a),b>r&&(h=a,r=b))}function d(){do c(a[e]),e+=1;while(0!==e%n&&e<a.length);e<a.length?p.execAtEndOfThread(d,
0):m.getAggregator().trigger("creativeFinderBatchCompleted",h)}var e=0,h=null,r=-1,n=50;if(a.length&&m.getAggregator().request("useYieldSearch"))d();else{for(e;e<a.length;e++)c(a[e]);m.getAggregator().trigger("creativeFinderBatchCompleted",h)}};return{searchDescendants:function(b){b=b||l.contextNode.parentNode;var c,d,e=[];for(c=0;c<g.length;c++){d=g[c].toLowerCase();var h=b.getElementsByTagName&&b.getElementsByTagName(d);if(h&&h.length)for(d=0;d<h.length;d++)e.push(h[d])}a(e)}}},Nb=function(){var g,
a=!1,b=!1,c=!1,d={status:k.RENDER.STATUS.OTHER,details:k.RENDER.DETAILS.OTHER},e={status:k.RENDER.STATUS.DETECTED,details:k.RENDER.DETAILS.ENVIRONMENT},h=m.getAggregator().request("omidAdSessionContext"),r=function(){c=a=!0},n=function(a){a&&(a.status=k.RENDER.STATUS.DETECTED);m.getAggregator().trigger("adRendered")},q=function(){var a=!1;u.isOmid()&&h&&h.useOMID13Logic&&(a=!0);return a},f=function(a){var b={},c=p.getDoc(),d=function(e){var h=e&&e.type;if("readystatechange"===h&&"complete"===e.target.readyState||
...
c=d,e=new ac,h=!0;m.getAggregator().on("evaluateCreativeFinderResult",function(a){if(t.isNodeXDomainIframe(a))b?p.clearInterval(b):h=!1,c=f(a);else if(a){var d=!1,r=t.getRect(a);a&&"IMG"===t.getNodeName(a)&&(d=0===a.naturalWidth||0===a.naturalHeight);!d&&r.width>=k.RENDER.WIDTH_THRESHOLD&&r.height>=k.RENDER.HEIGHT_THRESHOLD&&(n(c),b?p.clearInterval(b):h=!1);g.saveNode(a)}else a=e.getClosestContainerName()||g.getAdNodeName(a)||c.details,g.save(a);w(c)});var r=function(){var b=a&&a.getAdNode();try{e.find(b)}catch(c){m.getAggregator().trigger("renderdiag",
c)}},q=m.getAggregator().request("mobileApp");q&&q.isMobileAppEnvironment&&q.isMobileAppEnvironment()&&u.isMraid()?z():(r(),h&&(b=p.setInterval(r,500)));m.getAggregator().trigger("eligiblerender")})},l=function(){var a=h&&!!h.isVideo,c=h&&!!h.videoStartArrived,d=h&&!!h.geometryArrived;return b||!d||a&&!c?!1:(m.getAggregator().trigger("eligiblerender"),g.save(k.RENDER.DETAILS.ENVIRONMENT),g.save(k.RENDER.DIAGNOSTIC.OMID_RENDERED),n(),w(e),b=!0)};return{start:function(){var a=!1;m.getAggregator().trigger("perfCheckpoint",
{type:k.PERF_TIMELINE_TRACKER_CONFIG.RENDER.TYPE,timestamp:p.now(),code:"initial"});m.getAggregator().on("adRendered",function(){a=!0});m.getAggregator().provide("adRenderStatus",function(){return a});m.getAggregator().provide("useYieldSearch",function(){return c});g=new bc;new cc;m.getAggregator().on("impressionsent",r);q()?l()||(g.save(k.RENDER.DETAILS.ENVIRONMENT),g.save(k.RENDER.DIAGNOSTIC.OMID_UNRENDERED),w(d),m.getAggregator().on("omidrendgeoupdate",function(){l()}),m.getAggregator().on("omidrendvideostart",
...
saveNode:function(d){try{var e=d&&b(d),h=d&&t.getRect(d),r=d&&"IMG"===e,n=d&&t.hasBackgroundImage(d),q=d&&d.innerText&&0<d.innerText.length,g=d&&d.children&&0===d.children.length&&q,f=h&&h.width>=k.RENDER.WIDTH_THRESHOLD&&h.height>=k.RENDER.HEIGHT_THRESHOLD?k.RENDER.DIAGNOSTIC.QUALIFIED_SIZE:k.RENDER.DIAGNOSTIC.UNQUALIFIED_SIZE,B=(n||r)&&(0===d.naturalWidth||0===d.naturalHeight);a.push(e);a.push(f);B&&a.push(k.RENDER.DIAGNOSTIC.BROKEN_IMAGE);n&&a.push(k.RENDER.DIAGNOSTIC.STYLED_NODE);g&&a.push(k.RENDER.DIAGNOSTIC.TEXT_NODE)}catch(w){c("sne")}}}},
...
a.length&&a[0].state===b},addState:function(b){var e=a[a.length-1];b=g(b);c();0!==a.length&&b===e.state||a.push({state:b,duration:0})}}},Ba=function(g,a){var b=g||1,c=0,d=0,e,h=0;return{start:function(){0===c%b&&(e=p.now())},stop:function(){var r=e||a;0===c%b&&(h+=p.now()-r,d++);c++},getTime:function(){return h},getCount:function(){return d}}},Ca=function(){var g,a=0,b=0,c=new C(!0),d=function(){g&&(a++,c.trigger(a),b>a?p.execAtEndOfThread(d):e())},e=function(){g=!1;a=0};return{onTick:function(a,
...
h=!1},mark:function(){a=h?u.getTagTime()-d:0;c+=a;c>=g&&(b=c-a<g,e+=b?c:a);d=u.getTagTime();h=!0}}},P=function(g,a){var b=g||l.adsafeSrc||l.requrl;b&&0===b.indexOf("http")||(b=0===b.indexOf("//")?l.protocol+":"+b:l.protocol+"://"+b);var b=/((http|https):\/\/(([^\/\.]*)\.([^\/]*)))(?:\/(.[^?]*)\??(.+)?)*/.exec(b),c=b[1],d=b[2],e=b[3],h=b[4],r=b[5],n=g?b[6]:"",q=a?b[7]:"",s={},z=function(a){f.isDef(a)&&(h=a);return h},k=function(a){f.isDef(a)&&(r=a);return r},w=function(a,b){return a+"="+f(b).toION()},
q=q?q.replace(/&$/,""):"";return{appendToParamValue:function(b,c){var d,e;(d=s[b])?s[b]=d+c:a&&q.length&&(d=q.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),q=q.replace(d,d+c))},fullDom:c,hostname:e,sub:z,master:k,setParam:function(a,b){s[a]=s[a]||{};f(b).isObj()?f(s[a]).mixin(b):s[a]=b},path:function(a){n=a},toString:function(){var a=z()?z()+".":"",b=n?"/"+n:"",c;q||!f(s).isEmpty()?(c=f(s).isEmpty()?"":f(s).stringify(w,"&"),c="?"+q+(q&&c?"&"+c:c)):c="";return d+"://"+a+k()+b+c}}},
...
hasPostMessage:function(){var a=p.getWindow();return!(!a||!f.isFunction(a.postMessage))},getDocumentMode:function(){var a=p.getDoc();return a&&a.documentMode?a.documentMode:k.NA},getBrowserType:b,getUserAgent:c,params:function(){var c=b(),e;e=["{45EA75A0-A269-11D1-B5BF-0000F8051515}","{3AF36230-A269-11D1-B5BF-0000F8051515}","{89820200-ECBD-11CF-8B85-00AA005B4383}"];var h=k.NA,r=p.getDoc(),n=r.createElement("div");if(a(g.IE))try{if("-ms-ime-align"in r.documentElement.style)h="11";else for(n.style.behavior=
"url(#default#clientcaps)",r=0;r<e.length&&!(h=n.getComponentVersion(e[r],"componentid").replace(/,/g,"."));r++);}catch(q){}e=h;h=k.NA;n=p.getWindow();f.isDef(n.navigator)&&f.isDef(n.navigator.appName)&&(h=n.navigator.appName.toLowerCase()[0]);return{br:c,abv:e,an:h}},isAndroidWebViewBrowser:function(){var a=c(),b=["SamsungBrowser","FB_IAB","Silk"],h=function(){return f(b).findFirst(function(b,c){return J.contains(a,c)})};return J.contains(a,"Android")&&h()},getIOSVersion:function(){var a,b;(a=c())&&
...
d+'<script src="'+c+'">\x3c/script>'+e+"</body></html>"};return{isApplicable:function(a){g=m.getAggregator().request("omidAdSessionContext");var c=!(!g.app||!g.isDisplay||g.isWeb);a=a&&-1<a.indexOf("/blocking/")&&!u.integratedBlockingApplies(a);return c&&a},deployBlockingScriptIntoIframe:function(b){g=m.getAggregator().request("omidAdSessionContext");var c="iasbi"+l.asid,d;d=l.contextNode.parentNode;var e,h=l.adWidth&&0<l.adWidth?l.adWidth:0,r=l.adHeight&&0<l.adHeight?l.adHeight:0,n=p.getDoc().getElementsByTagName("ins"),
q;q=e=0;n&&0<n.length&&(q=n[0],e=parseInt(q.style.width),q=parseInt(q.style.height));h=e||h||window.innerWidth;r=q||r||window.innerHeight;"complete"===p.getDoc().readyState&&(l.forceAppend="true");"true"===l.forceAppend?(e=p.getDoc().createElement("IFRAME"),e.id=c,e.src="about:blank",d.appendChild(e)):p.getDoc().write('<iframe id="'+c+'" src="about:blank"></iframe>');if(d=p.getDoc().getElementById(c))d.style.width=h+"px",d.style.height=r+"px",d.scrolling="no",d.frameborder=0,d.style.position="absolute",
...
return{addNode:a,send:b,exec:c,notify:d,jsonp:e}},u=function(g){var a="undefined"===typeof window,b="undefined"!==typeof g&&"undefined"!==typeof top&&g!==top,c=function(){var b=!1;if(a)b=!0;else try{b=!!top.document}catch(c){}return b}(),d=function(){return a||f.isDef(p.getWindow().mraid)},e=function(){return!a&&f.isDef(p.getWindow().mraid)},h=function(){var b=!1;if(!a)var c=(b=p.getWindow().inmobi)&&b.IASDocumentVideoBuffer,b=b&&c&&f.isFunction(c.addVideoEventListener),b=e()&&!!b;return b},r=function(){var b;
...
l.use100v||!s()},usesGroupMCustomMetric:s,isCeltra:function(){var b=!1;a||(b=Ea().isApplicable());return b},usesGroupMCustomMetricMobilePassThru:function(){return s()&&n()},usesZeroPivCustomMetric:function(){return!1===f(l.customViewability).isArray()?!1:0<f(l.customViewability).filter(function(a,b){return f(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=p.getTop();window.addEventListener("message",function(b){/isRefreshable/g.test(b.data)&&
a(null,b&&b.data)},!1);b.postMessage(JSON.stringify({requestTop:"isRefreshable"}),"*")}catch(c){a(c)}},isPossiblyRefreshable:function(){return!a&&!d()&&!r()&&b&&"jload"===l.mode},integratedBlockingApplies:function(a){var b=!1,c,d,e;l.contextNode&&f.isFunction(l.contextNode.getAttribute)&&(c=l.contextNode.getAttribute("data-ias-check-tag"),d=l.contextNode.getAttribute("data-ias-check-done"),e=(e=l.contextNode.getAttribute("data-ias-callback"))&&f.isFunction(p.getWindow()[e]));var h=f.isDef(JSON)&&
f.isFunction(JSON.parse);a=l.integration&&(0<a.indexOf("skeleton.js")||0<a.indexOf("/internal/"));var r=!0===l.fwMonitoring||"true"===l.fwMonitoring;h&&a&&("true"===c&&"true"!==d&&e?(b=!0,r&&m.getAggregator().trigger("addOutputItem",{output:"imgb"},"smm",{type:"impression"})):(b=!1,r||m.getAggregator().trigger("addOutputItem",{output:"ibgm"},"smm",{type:"impression"})));return b}}}(x),y={addEvent:function(g,a,b,c){f.isDef(g.addEventListener)?"mouseenter"===a?g.addEventListener("mouseover",y.mouseEnter(b),
...
b&&b[g];f.isDef(d)&&0!==d&&f(c).contains(g)&&(a=a+"."+d);d=b[g];b[g]=f.isDef(d)?d+1:1;return a}();return{callType:g,enumerator:a}};Z.callTypeCounter={};var Jb=function(g,a,b,c,d,e,h,r){var n=0,q=0,s=!1,z=function(a,e,r,g,z,B){r=r||!b.on("postDts");var u=a===k.DT_CODES.DIAGNOSTIC||a===k.DT_CODES.ADTALK||a===k.DT_CODES.SCA||a===k.DT_CODES.XSCA||a===k.DT_CODES.EXTERNAL||a===k.DT_CODES.LARGE_BILLABLE;if(c.impressionIsIdentifiable()&&(u||"n"!==h.getCurrentLoc()))try{var t=l.dtBaseURL,x=new P(t,!0),y=p.now();
m.getAggregator().trigger("preSendDt",a);t||(x.path("dt"),b.on("usedtdomain")&&x.sub("dt"));w(x,a,e);z&&z.field&&x.setParam(z.field,z.value);g||v(x,a);m.getAggregator().trigger("send",x,function(){q+=1;n=p.now()-y;f.isFunction(B)&&B()},r);a===k.DT_CODES.UNLOAD&&(s=!0);d.cleanup()}catch(A){__IntegralASDiagnosticCall("dt-"+a,A),m.getAggregator().trigger("error",k.ERROR_CODES.PHONE_HOME)}};g=function(){s||z(k.DT_CODES.UNLOAD,-1,!0)};var B=function(a,c){var d={bapi:"a",bapiClient:"b",jload:"c",jss:"d",
jsi:"e"},e=l.mode,d=d[a]||d[e];b.on(c||e+"Diag")&&d&&z(k.DT_CODES.DIAGNOSTIC,-5,!0,!0,{field:"bkp",value:d})},w=function(a,b,e){var h=new Z(b);e=f.isDef(e)?e:h.enumerator;a.setParam("asId",l.asid);e={c:c.getCacheBustId(),pingTime:e,time:u.getTagTime(),type:b};d.filterOutput(function(a){var c=a.minDt&&(!a.type||a.type===b);c&&a.oneTime&&(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},v=function(c,g){var f,s={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===g},function(a,
b){c.setParam(a,b.replace("%3A",":"))});h.fastForward();if(g===k.DT_CODES.CUSTOM||g===k.DT_CODES.UNLOAD||g===k.DT_CODES.VIDEO_EVENTS||g===k.DT_CODES.FULLY_INVIEW||g===k.DT_CODES.PING||g===k.DT_CODES.VIEWABILITY_READY||g===k.DT_CODES.ADTALK)s.clog=r,u.isVideo()&&(f=u.isOmid()&&!u.isOmidForWeb()?"omidVideoEventsString":"videoEventsString",(f=m.getAggregator().request(f))&&!f.isEmpty()&&(s.ve=f));g===k.DT_CODES.UNLOAD&&(s.ndt=q);-1!==l.mode.indexOf("jsvid")&&(s.vv=m.getAggregator().request("videoVersion"));
s.NULL1=b.output();s.NULL2=h.stringify(10);s.em=u.embedded;s.fr=u.friendly;s.e=a.toString();s.tt=l.mode;s.dtt=n;d.filterOutput(function(a){var b=!a.standalone&&!a.minDt&&(!a.type||a.type===g);b&&a.oneTime&&(a.flagForRemoval=!0);return b},s);c.setParam("tv",s);c.setParam("br",e.getBrowserType())};m.getAggregator().on({sendDt:function(a,b,c){z(a,f.resolve(b),void 0,void 0,void 0,c)},sendMinDt:function(a,b){z(a,b,void 0,!0)},sendDiag:B,updateDtCount:function(){q++},unload:g});return{send:z,unload:g,
...
b&&d&&"DIV"===a.parentNode.nodeName||(c=a.parentNode);a=a.parentNode}return c},h=null,r=function(a){var b,c,h=null,r=-1;if(a.length)for(b=0,c=a.length;b<c;b++){var f=a[b],k=t.getNodeArea(f),m=f,l=void 0;if(l=m.parentNode===g)if(l=void 0,l="DIV"===m.nodeName)if(l=void 0,l=!e(m))if(l=void 0,!(l="0"===y.getStyle(m,"opacity")||"hidden"===y.getStyle(m,"visibility"))){for(var p=l=void 0,m=m.childNodes,l=0;l<m.length;l++)1===m[l].nodeType&&(p=!0);l=!p}(m=!l)&&d&&"DIV"===f.nodeName&&(m=!1);l=t.isEmptyTeadsFrame(f);
k>r&&m&&!l&&(h=f,r=k)}h&&(h.hasValidSizeForMobileApp=1<r);return h}(function(b){var c,d,e,h,r=[],g=a||"iframe img a object embed div".split(" ");c=0;for(d=g.length;c<d;c++){e=g[c].toLowerCase();var f=b.getElementsByTagName&&b.getElementsByTagName(e);if(f&&f.length)for(e=0,h=f.length;e<h;e++)r.push(f[e])}return r}(g));r&&(h=c(r),h.hasValidSizeForMobileApp=r.hasValidSizeForMobileApp);return h},screenSize:function(){if(u.isDomless())return{width:0,height:0};var g={width:-1,height:-1};try{f.isDef(x.screen)&&
...
getTask:function(){return e?function(){var c=m.getAggregator().request("adRenderStatus"),e=d||b,f=a.getTimeInViewInSeconds();c||m.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"nr_"+e,f)}:function(){var e=a.getTimeInViewInSeconds(),r=a.getTimeInViewForRts();f.isDef(d)&&(m.getAggregator().trigger("addOutputItem",{output:d},"metricId",{type:b}),m.getAggregator().trigger("addOutputItem",{output:"t"},"cmr",{type:b}));m.getAggregator().trigger("sendDt",b,e);if(c[r])c[r]()}}}},Ib=function(){return{createPingJobs:function(a,
b,c,d,e){return f(b.getTimeThresholds()).map(function(b,r){return new rc(r,a,c,d,e)})}}},Fa=function(){var a,b=[],c=function(a){return{type:a.tp||a.type||"",time:a.t||a.timestamp&&a.timestamp-l.birthdate||""}},d=function(){a||(a=m.getAggregator().request("viewabilityDefinitions"));a&&0==b.length&&f(a).each(function(a,c){c.qivThreshold&&b.push(c)})},e=function(a){var d=new c(a);a=["_","firstQuartile","midpoint","thirdQuartile","complete"];var e=a.indexOf(f(a).findFirst(function(a,b){return-1!==d.type.toLowerCase().indexOf(b.toLowerCase())})),
q=m.getAggregator().request("mScreenEvents").getCurrentEvent(),s=Math.floor(d.time/1E3);f(b).each(function(a,b){var c=!1,c=b.qivThreshold.indexOf(e);-1!==c&&b.isInView(q)&&0<b.qivThreshold.length&&(b.qivThreshold.splice(c,1),c=0==b.qivThreshold.length)&&(m.getAggregator().trigger("addOutputItem",{output:b.metricId},"metricId",{type:k.DT_CODES.CUSTOM}),m.getAggregator().trigger("addOutputItem",{output:"q"},"cmr",{type:k.DT_CODES.CUSTOM}),m.getAggregator().trigger("sendDt",k.DT_CODES.CUSTOM,s),b.rtsCallbacks&&
f.isFunction(b.rtsCallbacks[k.RTS_KEY_FOR_VQ])&&b.rtsCallbacks[k.RTS_KEY_FOR_VQ]())})};return{init:function(){d();m.getAggregator().on("videoQuartileEvent",function(a){d();e(a)})}}},ma=function(){var a=function(a,b){-1!==a.indexOf(b+"&")&&(b+="&");return a.replace(b,"")},b=function(a,b,c){var r=a.indexOf("?");b=b+"="+c;if(-1===r)return a+"?"+b;r++;return a.slice(0,r)+b+"&"+a.slice(r)},c=function(){var a=l.asid;return"__IntegralAS_"+(a&&a.replace(/\-/g,"")||"")+"_"+p.round(1E4*Math.random())};return{wrap:function(d,
e,h,r){var f=c(),q,s,k;r=r||"ias_callback";d=""+d;RegExp(r).test(d)&&(q=RegExp("("+r+"=)(.[^&]*)").exec(d)[0],s=q.split("=")[1],k=J.stringToFn(s),d=a(d,q));x[f]=function(a){e(a);h&&k&&k(a);x[f]=void 0};return d=b(d,r,f)},wrapToGlobal:function(a){var b=c();x[b]=function(c){a(c);x[b]=void 0};return b}}},Lb=function(a,b,c){var d=function(a,b){var c=a,d;b&&(d=","+f(b).stringify(function(a,b){return a+":"+b},","),c=P(a,!0),c.appendToParamValue("adsafe_jsinfo",d),c=c.toString());return c},e={jss:{isFW:!0,
...
a.callback:f.noop,d=a.enabled?!0:!1;m.getAggregator().trigger("jsonp",b,c,d)}},jsvid:{manualDefer:!0,impressionMethod:function(c){m.getAggregator().on("adImpression",function(e,n){var q;try{q=d(c,n),a.enabled?m.getAggregator().trigger("jsonp",q,a.callback,!0):m.getAggregator().trigger("send",q,f.noop,!b.on("postMon"))}catch(s){__IntegralASDiagnosticCall("jsvidimp",s,l)}})}},fwjsvid:{isFW:!0,manualDefer:!0,impressionMethod:function(a){var b="false"===l.fwMonitoring,c=function(a){a=a.split("/");a[3]=
...
w,l)}})}},jspix:{nodeType:"img"}};return new function(){var a=function(a){var b=-1===a.indexOf("?")?"?":"&";return a+b},b=e[l.mode],d=!!b.isFW,f=function(a){var b;b=m.getAggregator().request("mobileApp").isMobileAppEnvironment()&&l.mobFwUrl?l.mobFwUrl:a?l.adsafeSrc:l.requrl;a||(b+="?"+l.reqquery);return b}(d),s=f.indexOf("BEGIN__ADSAFE"),k=-1!==s,B=k?f.slice(s):"",a=k?f.slice(0,s):a(f);return{isFW:d,baseUrl:a,macroUrl:B,sendImpression:function(a){var d=function(){b.nodeType?m.getAggregator().trigger("addNode",
...
f(b.top.document.hasFocus).isObj())&&!b.top.document.hasFocus()||(f.isDef(a.prop)?p.getDoc()[a.prop]:null)):b=f.isDef(a.prop)?p.getDoc()[a.prop]:null;return b},r=function(){var b=p.getWindow(),c=function(){e.run(h())};y.addEvent(b,"focus",c,!0);y.addEvent(b,"blur",c,!0);a.event&&y.addEvent(p.getDoc(),a.event,c,!0)};a=function(){var a="hidden",c="visibilitychange",d=p.getDoc();f.isUndef(d.hidden)?f(["moz","ms","webkit"]).each(function(e,h){var r=h+"Hidden";f.isDef(d[r])&&(a=r,c=h+c,b=!0)}):b=!0;return b?
{prop:a,event:c}:{}}();return{isHidden:h,onHiddenChange:function(a){e.push(a);c||(c=!0,r())},supportsVisAPI:function(){return b}}},sc=function(){return{isHidden:function(){return!1},onHiddenChange:function(a){},supportsVisAPI:function(){return!0}}},Ab=function(){return{createInstance:function(a,b){return u.isDomless()?new uc:new vc(a,b)}}},vc=function(a,b){var c,d=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=a[b];(""===c||"null"===c||"undefined"===c||null===c||f.isUndef(c))&&delete a[b]}return a},
...
null!==h&&2==h.length&&(h=h[1].split("."),3==parseInt(h[0],10)&&6>=parseInt(h[1],10)&&(3==h.length?13>=parseInt(h[2],10)&&(e=!0):e=!0)))}e&&(a.g=d)}return a},q={};try{q.a=encodeURIComponent(top.location.href)}catch(s){}try{q.b=encodeURIComponent(parent.location.href)}catch(k){}if(u.embedded){try{q.c=encodeURIComponent(parent.document.referrer)}catch(m){}try{q.e=encodeURIComponent(x.document.referrer)}catch(w){}}try{"jsi"!==l.mode&&(q.d=encodeURIComponent(x.location.href))}catch(v){}try{q.f=encodeURIComponent(l.jsref)}catch(p){}try{h=
...
xb=function(a){var b=!1;return{measure:function(c){(b=0===c.rsa)&&a.trigger("notify",l._onSuspicious)},skipAsFraudulent:function(){return b}}},Bb=function(){var a=[],b={},c={sl:"n"},d=0,e,h,r,n={i:0,o:0,n:0,pp:0,pm:0},q=function(a){var b={},c=a.winDimensions,d=a.adDimensions;f.isDef(c)&&c.hasValidDims()&&(b.wc=c);f.isDef(d)&&d.hasValidDims()&&(b.ac=d,b.am=a.method,b.cc=a.containerDimensions);f({piv:"percentInView",obst:"obstructed",th:"tabHidden",reas:"reason"}).each(function(c,d){var e=a[d];f.isDef(e)&&
(b[c]=e)});c=f(b).toParams();return""===c?"":","+c},s=function(a,c){var d=new hc(c);return b[a]=d},z=function(a,b){return(b||"")+{inView:"i",outOfView:"o",na:"n",partialViewMinus:"pm",partialViewPlus:"pp"}[a]},l=function(){f(c).each(function(b,c){n[c]+=a.length?r-d:r});d=r},w=function(b){a.length&&l();f(b).each(function(a,b){var d=c[a];d!==b&&"n"===d&&(n[b]+=n.n);c[a]=b});a.length||l()},v=function(a){var c,d=a.adDimensions?a.adDimensions.getRounded():{width:0,height:0};c=q(a);var e={sl:z(a.viewState)};
r=u.getTagTime();w(e);e.t=r;c=f({toString:function(){f(b).each(function(a,b){b.fastForward()});return"{"+f(e).toParams()+this.details+this.breakdowns+"}"},details:c,breakdowns:{piv:[],as:[],toString:function(){var a,b=function(a,b){return b.duration+"~"+b.state};a=""+("piv:["+f(this.piv).stringify(b)+"]");a+=",as:["+f(this.as).stringify(b)+"]";return",bkn:{"+a+"}"}}}).mixin(e);f(c).mixin(a);c.width=d.width;c.height=d.height;f.isUndef(c.percentInView)&&(c.percentInView=k.PIV_NA);f.isUndef(c.reason)&&
(c.reason="");return h=c};(function(){s("piv",function(a){var b,c=a.percentInView,d=[1,25,30,50,75];100===c||0===c?b=c:(f(d).each(function(a,e){f.isUndef(b)&&c<e&&(b=d[a-1])}),f.isUndef(b)&&(b=d[d.length-1]));return b});s("as",function(a){var b=k.NA;a=a.adDimensions?a.adDimensions.getRounded():{width:b,height:b};return a.width+"."+a.height})})();return{fastForward:function(){r=u.getTagTime();l()},registerLocation:function(d){var h,r=!1;c.sl==z(d.viewState)&&a.length?(h=new v(d),a[a.length-1].details=
h.details):(h=new v(d),a.push(h),e=d.viewState,r=!0);m.getAggregator().trigger("newScreenEvent",h);f(b).each(function(b,c){-1!=="piv|as".indexOf(b)?(r&&c.clear(),c.addState(h),a[a.length-1].breakdowns[b]=c.get()):c.addState(h)});return h},stringify:function(b){var c="";a.length&&(c=f({slTimes:"{"+f(n).toParams()+"}",slEvents:"["+a.slice(-b).join(",")+"]",slEventCount:a.length}).toParams());return c},createViewabilityTracker:s,getCurrentLoc:function(){return z(e)},getCurrentEvent:function(){return h}}},
...
b,c){return a.on("usehaps")}}},Ga=function(a,b,c,d){var e,h=0,r=0,n=!1,q=function(){e=Math.round(t.getNodeArea(a.body));if(e>=d){for(var q,s=e+20*e/100,l=a.querySelectorAll("iframe"),l=f.fromNodeListToArray(l);l.length&&(r<s||h<c);)q=l.shift(),q=Math.round(t.getNodeArea(q)),q>=d&&(h++,r+=q);r>=s&&h>=c&&(s={va:e,bia:r,bin:h},m.getAggregator().trigger("addThrottledProp",k.DT_SLOT.FF,b,f(s).toION()),n=!0)}},s=function(){var b;b=new MutationObserver(function(a){n?b.disconnect():p.execAtEndOfThread(function(){f(a).each(function(a,
b){if(b.addedNodes.length){var c=b.addedNodes[0];c&&t.isElement(c)&&t.tagNameIs(c,"IFRAME")&&f.debounce(q,10)}})})});b.observe(a.body,{attributes:!1,childList:!0,characterData:!1})};a&&a.body&&(p.execAtEndOfThread(q),!n&&f.isDef(x.MutationObserver)&&s())},Cc={name:"BS_InApp",dependencies:[],creator:function(){var a=p.getWindow().document;m.getAggregator().request("mobileApp").isMobileAppEnvironment()&&Ga(a,"bs1",3,100)},settings:{tier:k.TIERS.VIEWABILITY,applies:function(a,b,c){b=c.isAvid()||c.isOmid()||
...
new Ec:new Fc(a)}}},Fc=function(a){var b,c,d,e=new za,h=new da,r=new Gc(e),n=new Hc,q=new Ic,s=new Jc(e,a),k=function(){f.isUndef(d)&&(d=new Kc(e));return d},l=function(){e.provide({frameCollection:function(){return r},adProxy:function(){return q},adTalkMessage:function(a){return new Lc(a,e)},adTalkMessageCollection:function(){return n},idMapModule:k,interFrameQuerySelector:function(a){return new Mc(a)}})};return{isApplicable:function(a){return f.isDef(x.JSON)&&f.isDef(x.postMessage)&&!a.isAvid()&&
!a.isOmidNative()},start:function(){l();h.traverse(r.addFrame);s.startListening();s.sendToKnownFrames();m.getAggregator().once("stopAdTalk",function(){s.stopListening()});m.getAggregator().provide("adTalkEventAggregator",e)},sendAdTalkCall:s.sendAdTalkCall,getFrameMap:function(){f.isUndef(b)&&(b=new Ha(e));return b},getFrameMapIncludingPeerCase:function(){f.isUndef(c)&&(c=new Ha(e,!0));return c},getIdMap:k}},Ec=function(){return{isApplicable:function(){return!1},start:function(){}}},Lc=function(a,
b){var c,d=b.request("adProxy").myIdCard,e=b.request("frameCollection").getMe().getStringifiedPosition();c=m.getAggregator().request("features").on("swapids")?l.oid:l.asid;var h=a||{},f=l.asid,d=d.tagId,n=u.embedded,q=u.friendly,s=l.birthdate;c=c.split("-")[2];var z;u.friendly?z="["+k.AD_IDENTIFIER+"-"+l.asid+"]":(z=p.getWindow(),z=z.location&&z.location.href,z='iframe[src*="'+(z&&z.replace(/^https?\:\/\//i,""))+'"]');return{messageContent:h,srcAsid:f,srcTagId:d,srcIsEmbedded:n,srcIsFriendly:q,srcBirthdate:s,
...
return{scrX:b,scrY:c}}}},Pc=function(a,b){var c,d,e=k.NA,h=e,r=!1,n=!1,q=!1,s=!b,z=function(){var b=p.getIntersectionObserver(function(a){a=a.pop();var b=a.intersectionRect.width*a.intersectionRect.height/(a.boundingClientRect.width*a.boundingClientRect.height)*100;isNaN(b)&&(b=0);e=Math.min(b,100);c=a.boundingClientRect;e!==h&&p.execAtEndOfThread(function(){m.getAggregator().trigger("IOPivChange",e)});h=e},{threshold:k.VIEWABILITY_IN_VIEW_THRESHOLDS_INTERSECTION_OBSERVER});s&&p.execAtEndOfThread(function(){e===
k.NA&&(e=0)});b.observe(l(a));s&&p.execAtEndOfThread(function(){u.isBustedIframe()||m.getAggregator().trigger("delayedViewabilityReady")});r=!0},l=function(b){if(!f.isUndef(b)){if(q){b=a.document;var c=b.createElement("div");f(c.style).mixin({position:"absolute",width:"100%",opacity:"0",height:"100%",zIndex:-999,top:"0px",left:"0px"});c[k.IAS_DETECTOR]=!0;b.body.appendChild(c);b=c}return d=b}};return{start:function(){var b;try{a.document&&(q=!0,b={bodyElement:a.document.body,document:a.document})}catch(c){n=
!0}b&&null!==b.bodyElement?z():b&&b.document?y.whenReady(z,b.document):n?m.getAggregator().request("errors").add(k.ERROR_CODES.BUSTED_IFRAME_IN_IO):z()},isReady:function(){return e!==k.NA},isStarted:function(){return r},getAdNodeDimensions:function(){var a;c&&(a=E({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},getObservedNode:function(){return d},getPiv:function(){return e}}},wa=function(){var a=!1;(function(){y.whenReady(function(){m.getAggregator().trigger("startViewabilityLoop");
...
field:"libraryVersion"},{root:"app",code:"appid",field:"appId"},{root:"deviceInfo",code:"dty",field:"deviceType"},{root:"deviceInfo",code:"osn",field:"os"},{root:"deviceInfo",code:"osv",field:"osVersion"}],f,r,q,s=0;s<d.length;s++)f=d[s].root,r=d[s].field,q=d[s].code,"object"===typeof h[f]&&"undefined"!==typeof h[f][r]&&h.queuedOutputItems.push({code:q,value:h[f][r]});h.queuedOutputItems.push({code:"oast",value:h.adSessionType});h.queuedOutputItems.push({code:"oacm",value:h.accessMode});h.queuedOutputItems.push({code:"oenv",
...
isMeasurable:0===d||75<=d,isObstructed:!1,isHidden:!1,numberOfAdverts:1,percentageInView:d,detectionMethod:"av"},b.trigger("screenLocationChanged",k)}catch(q){}};return{start:function(){try{var b=a.getAvidAdSessionContext().avidAdSessionType;c="display"===b||"video"===b;a.addEventListener("viewability",d)}catch(h){}},addScreenLocationChangedListener:function(a){b.on("screenLocationChanged",a)}}},bd=function(a,b){var c=[],d=(new Date).getTime(),e=0,h=0,r=!1,n=new Fa,q=m.getAggregator().request("omidAdSessionContext"),
s={isEmpty:function(){return 0===c.length},toString:function(){for(var a="{vEventCount:"+c.length+",vEvents:[",b=0;b<c.length;b++)var d=c[b],a=a+((0<b?",{":"{")+("t:"+d.t+",")+("tp:"+d.tp+",")+("sl:"+d.sl+",")+("ad_duration:"+d.ad_duration+",")+("volume:"+d.volume)+"}");return a+"]}"}},l=function(){r=!0},B=function(a){try{var s="",n=a.hasOwnProperty("timestamp")?a.timestamp:(new Date).getTime(),l="n",z=!1;switch(a.type){case "start":s="adVideoStart";q.videoStartArrived=!0;m.getAggregator().trigger("omidrendvideostart");
d=n;h=a.data.duration;1E3<h&&(h/=1E3);e=a.data.videoPlayerVolume;break;case "volumeChange":s="volumeChanged";e=a.data.videoPlayerVolume;break;case "firstQuartile":case "midpoint":case "thirdQuartile":case "complete":s="adVideo"+a.type.substring(0,1).toUpperCase()+a.type.substring(1);z=!0;m.getAggregator().trigger("videoQuartileEvent",a);break;case "pause":case "bufferStart":s="pauseAd";break;case "resume":case "bufferFinish":s="resumeAd";break;case "skipped":s="adSkipped"}if(""!==s){var B=m.getAggregator().request("mScreenEvents");
B&&(l=B.getCurrentLoc());c.push({t:n-d,tp:s,sl:l,ad_duration:h,volume:e})}if("loaded"===a.type&&f.isDef(a.data)){var p=["preroll","midroll","postroll","standalone"].indexOf(a.data.position),s=-1!==p?p+1:void 0,u=!0===a.data.autoPlay?"autoplayed":"clicktoplay";!0===r?(f.isDef(s)&&m.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"vbp",s),m.getAggregator().trigger("addThrottledProp",k.DT_SLOT.ENVIRONMENT,"vps",u)):(f.isDef(s)&&m.getAggregator().trigger("addOutputItem",{output:s},"vbp",
...
return{getOmidMeasurementStrategies:function(){var a=m.getAggregator().request("omidVerificationClient"),b=new aa(a),e=new Da,h=[];if(b.accepts()&&!e.accepts()){var f=new ba,k=new ed,e=new fd(a,new C),f=[{environment:f,measurementStrategy:new gd(a,new C)},{environment:k,measurementStrategy:new Ja(new ia,p.getWindow(),new C)}],f=(f=(new ha(f)).resolve())?f.measurementStrategy:{},q=new Ka(new La(new T),new T,k.accepts()),k=new Yc(a,b,l.mode),s=new Ma(e,f,new C,q),b=new Zc(a,b,l.mode),a=new Na(e,f,new bd(a,
new C),new C,q);h.push({environment:k,measurementStrategy:s});h.push({environment:b,measurementStrategy:a})}return h},getAvidMeasurementStrategies:function(){var b=m.getAggregator().request("avidJsClient"),d=new Wc(b),e=[];if(d.accepts()){var h=new Vc(b,d,l.mode),f=new Xc(b,d,l.mode),k;k=new $c(b,new C);if(d.supportsAdContainerGeometry()){var q=new hd,s=new id,z=new Ja(new ia,p.getWindow(),new C),B=new jd(b,new C),q=(q=(new ha([{environment:q,measurementStrategy:B},{environment:s,measurementStrategy:z}])).resolve())?
q.measurementStrategy:{},s=new Ka(new La(new T),new T,s.accepts()),z=new kd(b,new C),b=new Ma(z,q,new C,s);k=new Na(z,q,k,new C,s)}else s=new ad(b,new C),b=new Ia(s,new C),k=new Oa(s,k,new C);e.push({environment:h,measurementStrategy:b});e.push({environment:f,measurementStrategy:k});a.setAvidAdSessionContext(d.getAvidAdSessionContext())}return e},getMraidMeasurementStrategies:function(){var a=[],d=b.isSafeToInjectMraid(),d=new ld(p.getWindow(),d,b.isMobileAppEnvironment());if(d.accepts()){var e=m.getAggregator().request("context"),
...
d;if(f.isDef(c))if(a.environment.supportsAdContainerGeometry())e=c;else if(c.shouldDelegateToDomBasedViewability)e=b,e.method=c.method;else if(0===c.percentInView||75<=c.percentInView)e=c;return e},start:function(){var b;f.isDef(a)&&f.isDef(a.measurementStrategy)&&(b=a.measurementStrategy,b.addMeasurementChangedListener(h),b.start())},requiresDelayedViewabilityEvent:function(){b=!0}}},Oa=function(a,b,c){var d=!1,e=!1,h=!1,r,n,q,s,l=function(){if(!f.isUndef(n)){var a=[],b,l;d?(e?(l=!1,b=100):(l=s,
b=q),50>b&&a.push(k.OUT_OF_VIEW_REASONS.GEOM)):(l=!1,b=0,a.push(k.OUT_OF_VIEW_REASONS.VIDEO));h=!0;n.shouldDelegateToDomBasedViewability=l;n.percentageInView=b;n.viewState=50>b?k.OUT_OF_VIEW:k.IN_VIEW;n.outOfViewReason=a.join(".");r=n;c.trigger("measurementChanged",r)}},B=function(a){n=a;q=a.percentageInView;s=a.shouldDelegateToDomBasedViewability;l()},p=function(a){a=a.eventType;"AdEnteredFullscreen"===a?e=!0:"AdExitedFullscreen"===a?e=!1:-1!=="AdStarted|AdVideoStart|AdPlaying".indexOf(a)?d=!0:-1!==
...
r=function(a,b){return{x:a.x+b.x,y:a.y+b.y,width:b.width,height:b.height}},n=function(a,b){return{x:b.x-a.x,y:b.y-a.y,width:b.width,height:b.height}};return{calculateGeometricMeasurement:function(e,s){if(f.isDef(e)&&f.isDef(s)){var l=e.viewport,m=e.computedAdContainer,w=m.obstructions,v=w&&0<w.length,u=e.originalAdContainer,t=s.adGeometry,L=s.adFound,x=e.detectionMethod,y=0,l={x:0,y:0,width:l.width,height:l.height},Q=r(u,t),F=e.outOfViewReason,A=0,H=0,C=v||!1,A=1>=t.width*t.height;c&&A&&(L=!1,F=F||
"",L||-1!==F.indexOf(k.OUT_OF_VIEW_REASONS.GEOM)||(F=k.OUT_OF_VIEW_REASONS.GEOM+(""!==F?"."+F:"")));if(L&&0<e.percentageInView){A=d(l,m,Q);v?(y=n(m,Q),y=h(l,m,y),y=r(m,y),y=a.calculateObstructedArea(y,w)):y=0;H=y;y=Math.round((A-H)/(Q.width*Q.height)*100);v&&0===H&&(C=!1);for(var t=(new E(Q)).getRoundedGeometry(),L=C,D,v=0,H=b.getConfig(t).numberOfSlices,S=p.floor(t.height/H)||1,w=[],A=L?a.getObstructionStatusBySlice(H):[],U,v=0;v<H;v++)D=t.y+S*v,v==H-1&&(S=t.y+t.height-D),D={x:t.x,y:D,width:t.width,
height:S},U=d(l,m,D),D=1==U/(D.width*D.height),w.push(D);if(L)for(m=p.min(A.length,H),v=0;v<m;v++)w[v]=w[v]&&!A[v];m=w}else m=b.getConfig(t).defaultSliceArray;return{windowDimensions:l,containerDimensions:u,adDimensions:Q,percentageInView:y,viewState:50<=y?k.IN_VIEW:k.OUT_OF_VIEW,outOfViewReason:50<=y?"":F||k.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:x,isObstructed:C,sliceStatus:m}}}}},hd=function(){return{accepts:function(){return u.isAvidNative()}}},jd=function(a,b){var c=function(a){var c=a.eventData.originalAdContainer;
a=!!c;c=(new E({x:0,y:0,width:a?c.width:0,height:a?c.height:0})).getRoundedGeometry();b.trigger("avidNativeGeometryChanged",{adGeometry:c,adFound:a})};return{start:function(){a.addEventListener("viewability",c)},addAdGeometryMeasurementChangedListener:function(a){b.on("avidNativeGeometryChanged",a)}}},id=function(){return{accepts:function(){return u.isAvid()&&!u.isAvidNative()}}},Ma=function(a,b,c,d){var e,h,r,n=function(){if(f.isDef(e)&&f.isDef(h)){var a=d.calculateGeometricMeasurement(e,h);r=a.isMeasurable=
!0;c.trigger("geometryMeasurementChanged",a)}},q=function(a){e=a;n()},s=function(a){h=a;n()};return{start:function(){m.getAggregator().trigger("addOutputItem",{output:k.MEDIA_TYPE.DISPLAY_CODE},k.MEDIA_TYPE_CODE,{type:k.IMPRESSION_EVENT});a.addAdContainerGeometryMeasurementChangedListener(q);a.start();b.addAdGeometryMeasurementChangedListener(s);b.start()},addMeasurementChangedListener:function(a){c.on("geometryMeasurementChanged",a)},getStrategyName:function(){return k.MEASUREMENT_STRATEGY.DISPLAY},
isMeasurable:function(){return r}}},La=function(a){var b=[],c;return{calculateObstructedArea:function(d,e){var h,k,n,q;k=e&&0<e.length;var s;if(k){s=Math.round(d.width);var l=Math.round(d.height);h=Array(s);for(n=0;n<s;n++)h[n]=Array(l);s={matrix:h,obscuredPixelCount:0,x:Math.round(d.x),y:Math.round(d.y),width:s,height:l}}else s={};h=s;l=s=0;if(k){for(;s<e.length;s++){k=e[s];n=l=h;var m=k;h=Math.max(n.x,m.x);k=Math.max(n.y,m.y);q=Math.min(n.x+n.width,m.x+m.width);m=Math.min(n.y+n.height,m.y+m.height);
n=q-h;q=m-k;n=0<n?n:0;q=0<q?q:0;h-=l.x;k-=l.y;n=h+n;q=k+q;for(h=Math.round(h);h<Math.round(n);h++)for(m=Math.round(k);m<Math.round(q);m++)void 0!==l.matrix[h]&&void 0===l.matrix[h][m]&&(l.matrix[h][m]=1,l.obscuredPixelCount+=1);h=l}l=h.obscuredPixelCount;s=h;if(f.isUndef(s.matrix)||0===s.matrix.length)c=[];else{k=0;q=!1;h=s.matrix[0].length;n=s.matrix.length;q=a.getConfig({height:h}).numberOfSlices;for(var m=p.floor(h/q)||1,w=[],v=0;v<h;v++){q=!1;for(var t=0;t<n;t++)if(1===s.matrix[t][v]){q=!0;break}k++;
q&&(v+=m-k,k=m);if(k==m||v===h-1)w.push(q),k=0}c=w}}else c=b;return l},getObstructionStatusBySlice:function(){return c}}},fd=function(a,b){var c=m.getAggregator().request("omidAdSessionContext"),d=null,e=!1,h=new ga,r=function(){var a=p.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(n(d),d=null)):p.setTimeout(r,50)},n=function(a){if(a&&a.data&&a.data.adView){var f=a.data.adView,n=!!(f.measuringElement&&f.containerGeometry&&f.onScreenContainerGeometry);
if(c.delayingViewabilityEvents)d=a,e||(e=!0,r());else{n&&f.onScreenGeometry.obstructions&&0<f.onScreenGeometry.obstructions.length&&(f.onScreenContainerGeometry.obstructions=f.onScreenGeometry.obstructions);var l=new E(a.data.viewport||{width:0,height:0}),p=new E(f[n?"containerGeometry":"geometry"]||{x:0,y:0,width:0,height:0}),n=new E(f["onScreen"+(n?"Container":"")+"Geometry"]||{x:0,y:0,width:0,height:0}),f={viewport:l.getRoundedGeometry(),originalAdContainer:p.getRoundedGeometry(),computedAdContainer:n.getRoundedGeometry(),
...
ba=function(){var a=m.getAggregator().request("omidAdSessionContext");return{accepts:function(){return a&&(a.isNative||a.isLimitedSandbox)}}},gd=function(a,b){var c=m.getAggregator().request("omidAdSessionContext"),d=null,e=!1,f=new ga,r=function(){var a=p.getDoc().getElementById("iasbi"+l.asid);a&&a.hasAttribute("CreativeLoaded")?(e=c.delayingViewabilityEvents=!1,d&&(n(d),d=null)):p.setTimeout(r,50)},n=function(a){if(a&&a.data&&a.data.adView)if(c.delayingViewabilityEvents)d=a,e||(e=!0,r());else{var n=
...
d)},r=function(){var b=a.mraid;e()&&(c=!0,"loading"===b.getState()?b.addEventListener("ready",function(){h()}):h())},n=function(){c||r()};return{start:function(){var b=!0;if(f.isDef(a.mraid)||t.containsScriptTagWithSrc("mraid.js"))b=!1;m.getAggregator().trigger("addOutputItem",{output:f.stringifyTriState(b)},"mi",{type:"impression"});b?m.getAggregator().trigger("exec","mraid.js",n):r()},addScreenLocationChangedListener:function(a){b.on("mraidScreenLocationChanged",a)}}},hb=function(a,b,c){var d={},
...
p.max(a.fullPercentInView||0,a.percentInView);return-1!==(k.IN_VIEW+"|"+k.PARTIAL_VIEW_PLUS).indexOf(a.viewState)&&100===b},applies:function(){return b.usesGroupMCustomMetric()},minUnit:1E3,shouldIncludeSound:!1}},gb=function(a,b){var c,d,e,h=p.getMaxNumber(),m=b.isVideo(),n=a.id;d=a.sound&&"on"===a.sound;var q=!(a.soundExcl&&"groupm_native"===a.soundExcl&&l.groupm_native_publisher)&&d,s=function(b,c){if(!b.adDimensions)return!1;var d=c?"percentInViewIgnoringRender":"percentInView",e,n,l,s=b.adDimensions.area();
l=1===b.tabHidden;var t=p.max(b.fullPercentInView||0,b[d]),d=f(a.thresholds).findFirst(function(a,b){e=b.lb||0;n=b.ub||h;if(s>=e&&s<=n)return!0});l=!l&&t>=d.piv;b.method==k.DETECTION_METHODS.AD_PLACEHOLDER&&0===a.tiv&&(l=!1);m&&(l=l&&b.isVideoPlaying,q&&(l=l&&b.isSoundOn));return l};c=new K(a);d=a.qiv;(function(){e={};var a;f.isDef(l.rts)&&f.isDef(l.rts[n])&&(a=c&&f.isFunction(c.getTimeThresholds)&&c.getTimeThresholds()[0],a=f.isDef(a)?f.isFunction(a.getTimeInViewForRts)&&a.getTimeInViewForRts():
k.RTS_KEY_FOR_VQ,e[a]=l.rts[n])})();return{timeInViewThresholds:c,qivThreshold:d,type:k.DT_CODES.CUSTOM,rts:e,isInView:s,isInViewIgnoringRender:function(a){return s(a,!0)},metricId:n,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:q,sendOtherwiseInViewSignal:!0}},fb=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",h=b.isDeviceTypeGroupMobile()?"mobile":"desktop",k=f(a.customViewability).isArray()&&0<a.customViewability.length,n=
c.on("customMetric"),q=c.on("groupmCM"),l=function(a,b){var c,k,n,l,m;c=f(b.mediaTypes).contains(d);k=f(b.distributionChannels).contains(e);n=f.isDef(b.deviceGroups)?f(b.deviceGroups).contains(h):!0;l=J.contains(b.id,"fiv");m=J.contains(b.id,"groupmCM");l=!l;m&&(l=q);return l&&c&&k&&n};return{resolve:function(){var b=[],c;n&&k&&(c=f(a.customViewability).filter(l),f(c).each(function(a,c){b.push(c)}));return b}}},K=function(a){var b=[];if(f(a.tiv).isArray())f(a.tiv).each(function(a,c){b.push(new ja(c))});
...
a;b.start(!0);m.getAggregator().on("IOPivChange",e);m.getAggregator().on("nodesAdded",f)}}},Cd=function(a,b,c,d,e,h){var r,n,q,s,z,B,w,v,N,M=t.getElementsWindow(b);t.getElementsDocument(b);m.getAggregator().provide("iframeCalculatorHelper",vd(M));var A=wd(b,d),D=k.AD_IDENTIFIER+"-"+l.asid,C=!1,Q=E({}),F=u.isDeviceTypeGroupMobile(),I=u.usesGroupMCustomMetricMobilePassThru(),H,J=function(){if(!r)if(r=A.calcDims(b,d,q),c===k.DETECTION_METHODS.VIDEO&&u.embedded){var a=r,e=(new E(b)).getRounded();try{a.set("width",
e.width),a.set("height",e.height)}catch(f){m.getAggregator().trigger("error",k.ERROR_CODES.VIDEO_IN_IFRAME_DIMS_CALC)}}else c===k.DETECTION_METHODS.AD_PLACEHOLDER&&r.treatAsPlaceholder();return r},K=function(){var b,d=u.xDomainIframe&&C;b=F&&C&&q.isReady();b=d||b;d=A.getClippedDims&&(c===k.DETECTION_METHODS.VIDEO&&u.embedded||u.isCeltra());b?n=q.getPiv():f.isUndef(n)&&(b=!F&&(u.friendly||f.isDef(x.mozInnerScreenX))&&e.on("offscreen"),v=J(),w=new E(t.calcWinDims()),B=new E(b?t.calcMonDims():{}),N=
d?A.getClippedDims():Q,n=a.calcPercentInView(v,w,B,N));return n},S=function(){return a.calcInitialViewState(K())},U=function(){return b===x?!1:J().isHidden()};(function(){var d=p.getWindow(),e=p.getDoc(),f=b===d,h=e.body,n=m.getAggregator(),l=new Y,r=n.request("browser"),v=n.request("features"),n=n.request("context"),t=!u.xDomainIframe,e=f&&h?e.body:b;H=u.friendlyIframe?d.frameElement:e;y.addEvent(e,"click",function(){m.getAggregator().trigger("adComponentClicked")});y.addEvent(e,"mouseover",function(){m.getAggregator().trigger("adComponentMousedOver")});
l.applies(r,v,n)?(q=Pc(b,t),q.start(),C=!0,I&&c!==k.DETECTION_METHODS.AD_PLACEHOLDER&&(d=new xd(J().getRounded()),l=new yd,l=new zd(q.getObservedNode(),l),s=new Ad(d.getSlices(),l))):I&&(z=new Bd(a))})();return{mark:function(){t.setAttributeOf(H,D,"")},cleanup:function(){t.removeAttributeOf(H,D)},isNode:function(a){return b===a},isHidden:U,isObstructed:function(){return!1},getDims:J,getPercentInView:K,getLocationState:S,getOnPageViewability:function(){return U()?k.OUT_OF_VIEW:S()},getDetectionMethod:function(){return c},
getContainerDims:function(){return A.allowsOptimization?r:E(d)},refresh:function(){N=v=w=B=n=r=void 0;if(h){var a,c;if(!u.isDomless()&&(c=b.parentNode)){for(;b!==x&&c&&c!==G&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;s&&s.isReadyToMeasure()?a=s.getSliceStatus():u.friendly&&z&&f.isDef(v)&&(a=z.getSliceStatus(v,w,B,N));return a}}},Dd=function(a,b){var c=[],d,e=f([]),h=function(){return c[0]&&c[0].getDetectionMethod()===k.DETECTION_METHODS.AD_PLACEHOLDER},
l=function(l,n,q,s){var r=h()||0===c.length;l=Cd(a,l,n,q,b,s);h()&&(q=c.shift(),e=f(c),q.cleanup(),d=void 0);c.push(l);e=f(c);r&&l.mark();r&&n!==k.DETECTION_METHODS.AD_PLACEHOLDER&&m.getAggregator().trigger("primaryadfound",l)},n=function(){if(d)return d;var a,b=!1,c=0,f=0;e.each(function(d,e){var h;h=e.getDims();h.hasValidDims()&&(a=e.getPercentInView(),b=a!==k.NA,h=h.area(),c+=h,f+=a/100*h)});return d={totalArea:c,totalInView:f,hasMeasurement:b}},q=function(a){var b=m.getAggregator().request("adRenderStatus");
return!a&&!b},s=function(a){var b;b=n();b=b.hasMeasurement?p.round(b.totalInView/b.totalArea*100):k.PIV_NA;if(isNaN(b)||q(a))b=0;return b},z=function(c){var d=b.bootstrapOn("mobOrTab"),d=n().totalArea>=k.MRC_LARGE_AD_SIZE&&b.on("largeAd")&&!d&&!u.isVideo();return a.calcInitialViewState(s(c),d)},t=function(a){var b=-1;e.each(function(c,d){d.isNode(a)&&(b=c)});return b},w=function(a){return function(){return c[0]&&c[0][a]()}};m.getAggregator().on("adComponentAdded",function(a){f(a).each(function(a,
b){-1===t(b)&&l(b,k.DETECTION_METHODS.MUTATION)})});m.getAggregator().on("adComponentRemoved",function(a){f(a).each(function(a,b){var d=t(b);-1<d&&c.splice(d,1)})});return{getDims:w("getDims"),isObstructed:w("isObstructed"),getDetectionMethod:w("getDetectionMethod"),getContainerDims:w("getContainerDims"),getViewState:z,getViewStateIgnoringRender:function(){return z(!0)},getPercentInView:s,getPercentInViewIgnoringRender:function(){return s(!0)},isHidden:w("isHidden"),isUsingPlaceholder:h,hasAd:function(){return!!c.length},
refresh:function(){d=void 0;e.each(function(a,b){b.refresh()})},addAdComponent:l,getOutOfViewReasons:function(a){var b,e=[],f=c[0],h=k.OUT_OF_VIEW_REASONS;f&&(b=d||z(),q(a)?e.push(h.RENDER):b!==k.OUT_OF_VIEW&&b!==k.PARTIAL_VIEW_MINUS||e.push(h.GEOM),f.isHidden()&&e.push(h.HIDDEN),f.isObstructed()&&e.push(h.OBSTRUCTION));return e},getComponentCount:function(){return c.length},getComponents:function(){return c},getSliceStatus:w("getSliceStatus")}},Ed=function(a){var b=!1;if(!f.isUndef(x.MutationObserver)){var c=
new x.MutationObserver(function(a){p.execAtEndOfThread(function(){b&&f(a).each(function(a,b){b.addedNodes.length&&m.getAggregator().trigger("adComponentAdded",b.addedNodes);b.removedNodes.length&&m.getAggregator().trigger("adComponentRemoved",b.removedNodes)})})}),d=function(){b=!0;p.setTimeout(function(){b=!1},40)};m.getAggregator().on("adComponentClicked",d);m.getAggregator().on("adComponentMousedOver",d);y.whenReady(function(){try{c.observe(G.body,{attributes:!0,childList:!0,characterData:!0})}catch(b){a.add(k.ERROR_CODES.AC_WATCHER)}},
p.getDoc())}},Md=function(a,b){var c=[Fd(),Gd()],d=[ia(),Hd(),Id(),Jd(),Kd(),Ld()],c=c.concat(d);return f(c).findFirst(function(c,d){return d.isApplicable(a,b)})},Id=function(){var a,b,c,d=function(a){a?a&&c&&(p.execAtEndOfThread(function(){m.getAggregator().trigger("delayedViewabilityReadyCallOnly")}),c=!1):c=!0};return{detectionMethod:function(){return b&&b.detectionMethod},isApplicable:function(a){return a.isBustedIframe()},find:function(){b=b||fa();var c=t.crossQuerySelector(fa().getCssSelector(),
!0);a=c?c.parentNode:a;d(c);return c},getAdContainer:function(){return a},allowForAdContainerChange:!0}},Nd=function(a,b){var c,d=t.findChildWithLargestContent(a||l.contextNode.parentNode,b);1<t.getNodeArea(d)&&!d[k.IAS_DETECTOR]&&(c=d);return c},Kd=function(){return{detectionMethod:k.DETECTION_METHODS.IFRAME,find:function(){return x},isApplicable:function(){return u.embedded},getAdContainer:function(){return l.contextNode.parentNode},allowForAdContainerChange:!0}},Od=function(){var a,b=p.getDoc().scripts,
c=function(){a||(a=f(b).findFirst(function(a,b){return J.contains(b.src,"servedby.flashtalking")}));return a},d=function(){var b,d=a||c(),f=/;(\d+);/;d&&d.src&&(b=d.src.match(f)[1]);return b};return{detectionMethod:k.DETECTION_METHODS.BUSTED_IFRAME_FLASHTALKING,isApplicable:function(a,b){return b.on("bustediframe")&&a.embedded&&void 0!==c()},getCssSelector:function(){var a,b=d();try{a=f(["#ftdiv"+b,"#ftframe"+b]).findFirst(function(a,b){return t.crossQuerySelector(b,!0)})}catch(c){}return a}}},Pd=
function(){return{isApplicable:function(a,b){var c;try{c=t.getFrameId()}catch(d){}return b.on("yieldmo")&&c&&J.contains(c,"_tpi")&&t.crossQuerySelector("[data-href*='ads.yieldmo.com']",!0)},getCssSelector:function(){return"[id='"+t.getFrameId().replace("_tpi","")+"']"},detectionMethod:k.DETECTION_METHODS.BUSTED_IFRAME_YIELDMO}},Qd=function(){var a,b,c=p.getDoc(),d=function(){var b;a||(a=(b=(b=t.querySelector(c,"div[id*='ebDiv']"))&&b.id)&&b.split("ebDiv")[1]);return a},e=function(){var a;b||(b=(a=
(a=t.crossQuerySelector("iframe[id*='ebBannerIFrame_'][id$='"+d()+"']",!0))&&a.id)&&"#"+a);return b};return{detectionMethod:k.DETECTION_METHODS.BUSTED_IFRAME_SIZMEK,isApplicable:function(a,b){var c=p.getWindow(),k=a.friendlyIframe&&p.getWindow().frameElement,k=k&&E(k).isOneByOne(),l=function(){var a=p.getDoc().scripts;return f(a).findFirst(function(a,b){return J.contains(b.src,"bs.serving-sys.com/BurstingPipe/adServer")})}(),c=c.EBG&&c.EBG.ads&&!f(c.EBG.ads).isEmpty();return b.on("sizmek")&&l&&c&&
k&&d()&&e()},getCssSelector:e}},fa=function(){var a,b=m.getAggregator().request("features");a||(a=[Qd(),Pd(),Od()]);return f(a).findFirst(function(a,d){return d.isApplicable(u,b)})},Jd=function(){var a,b=function(){p.execAtEndOfThread(function(){m.getAggregator().trigger("delayedViewabilityReadyCallOnly")})};return{usePlaceholder:!1,detectionMethod:k.DETECTION_METHODS.VENDOR_CELTRA,isApplicable:function(a,b){return b.on("celtra")&&a.isCeltra()},find:function(){var c,d=Ea().find();d&&d.celtra&&d.celtra.loaded&&
(c=d.celtra.viewabilityObservee,a=t.getElementsWindow(c).frameElement||c.parentNode,b());return c},getAdContainer:function(){return a},allowForAdContainerChange:!1}},Ea=function(){var a,b=function(){var b;(b=l.contextNode.parentNode)&&J.contains(b.className,"celtra-ad-v3")?a=b:(b=b&&t.querySelector(b,".celtra-ad-v3"))&&(a=b);return a};return{find:b,isApplicable:function(){return void 0!==b()}}},ia=function(){var a=m.getAggregator().request("mobileApp");return{usePlaceholder:!0,detectionMethod:k.DETECTION_METHODS.AD_HUNT,
isApplicable:a.isMobileAppEnvironment,find:function(){var a=t.findChildWithLargestContent(p.getDoc().body);return a&&a.hasValidSizeForMobileApp&&!a[k.IAS_DETECTOR]?a:void 0},getAdContainer:function(){return l.contextNode.parentNode},allowForAdContainerChange:!0}},Gd=function(){var a;return{detectionMethod:k.DETECTION_METHODS.SPECIFIED_AD,isApplicable:function(){return u.isSpecifiedAd()},find:function(){var b=t.crossQuerySelector(l._cl_adpath);b&&(a=t.getParent(b),1>t.getNodeArea(b)&&(a=b,b=t.findElementsWithSize(b)));
return b},getAdContainer:function(){return a},allowForAdContainerChange:!0}},Fd=function(){var a;return{detectionMethod:k.DETECTION_METHODS.SPECIFIED_AD_COMPOUND,isApplicable:function(){return u.isCompoundAd()},find:function(){var b=[],c;/\[(.*)\]/.exec(l._cl_adpath)[1].split(",").forEach(function(d){if(c=t.crossQuerySelector(d))a=t.getParent(c),1>t.getNodeArea(c)&&(a=c,c=t.findElementsWithSize(c));b.push(c)});return b},getAdContainer:function(){return a},allowForAdContainerChange:!0}},Ld=function(){return{usePlaceholder:!0,
detectionMethod:k.DETECTION_METHODS.AD_HUNT,isApplicable:function(){return!0},find:Nd,getAdContainer:function(){return l.contextNode.parentNode},allowForAdContainerChange:!0}},Hd=function(){return{detectionMethod:k.DETECTION_METHODS.VIDEO,find:m.getAggregator().request("video").findAdNode,isApplicable:u.isVideo,getAdContainer:function(){return l.contextNode.parentNode},allowForAdContainerChange:!0}},wd=function(a,b){var c,d;c=[Rd(),Sd(),Td()];d=f(c).findFirst(function(c,d){return d.isApplicable(a,
b)});c=Ud();c.isApplicable(b)&&(c.setBaseStrategy(d),d=c);return d},Td=function(){return{calcDims:function(a,b){var c,d,e=new E(a);t.isClippable(a,b)&&(c=t.getClippedDimensions(a,b),d=e.getRounded(),e.set("height",c.height<d.height?c.height:d.height||1),e.set("width",c.width<d.width?c.width:d.width||1));return e},allowsOptimization:!1,isApplicable:function(a){var b=(u.isSpecifiedAd()||u.isBustedIframe())&&t.nodeIsInWindow(a,p.getTop());a=!t.elementIsEmbedded(a);return b||a}}},Sd=function(){var a=
m.getAggregator().request("iframeCalculatorHelper");return{calcDims:a.calcDims,getClippedDims:a.getClippedDims,allowsOptimization:!0,isApplicable:function(a){return!(u.isSpecifiedAd()||u.isBustedIframe())&&t.elementIsEmbedded(a)}}},Rd=function(){var a=m.getAggregator().request("iframeCalculatorHelper");return{calcDims:function(b){var c=a.calcDims();b=(new E(b)).getRounded();c.set("height",b.height);c.set("width",b.width);return c},getClippedDims:a.getClippedDims,allowsOptimization:!1,isApplicable:function(a,
c){var d=(u.isSpecifiedAd()||u.isBustedIframe())&&u.embedded&&!t.nodeIsInWindow(c,p.getTop()),e=u.isCeltra()&&t.elementIsEmbedded(a);return d||e}}},Ud=function(){var a;return{calcDims:function(b,c,d){d=f.isDef(d)?d.getAdNodeDimensions():void 0;a&&f.isUndef(d)&&(d=a.calcDims(b,c));return d},isApplicable:function(a){a=Y();var c=m.getAggregator(),d=c.request("browser"),e=c.request("features"),c=c.request("context");return c.isDeviceTypeGroupMobile()&&a.applies(d,e,c)},allowsOptimization:!1,setBaseStrategy:function(b){a=
b}}},vd=function(a){var b,c,d,e=m.getAggregator().request("features"),h=m.getAggregator().request("browser");a=a||p.getWindow();var l=function(b,c){b=b||a;c=c||{top:0,left:0,width:p.getMaxNumber(),height:p.getMaxNumber()};for(var d,e=b.parent.frames,f=!1,h=0,n=e.length;h<n;h++)if(e[h]==b){d=e[h];f=!0;break}if(f){d=t.getRect(d.frameElement);c.left+=d.left;c.top+=d.top;try{c.width=p.min(c.width,d.width),c.height=p.min(c.height,d.height)}catch(u){m.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}b!==
p.getTop()&&l(b.parent,c)}return c},n=function(){var n,s={};try{var z,B,w,v,x,y,A=p.getMaxNumber(),D=p.getMaxNumber();u.friendly?(z=l(),w=z.left,v=z.top,A=z.width,D=z.height,B=t.browserWindowPosition(),x=B.scrX+w,y=B.scrY+v):e.on("rattie")&&h.browserIs(k.BROWSERS.IE)?(d=d||m.getAggregator().request("ieXDomainViewability"),c=d.determineFramePosition(),x=c.scrX,y=c.scrY):f.isDef(a.mozInnerScreenX)&&(x=p.round(a.mozInnerScreenX),y=p.round(a.mozInnerScreenY));var s={scrX:x,scrY:y,iFrameClippingWidth:A,
iFrameClippingHeight:D},C,E,F=b||t.getIeDimObj(a);b=F;f.isDef(a.innerWidth)?(C=a.innerWidth,E=a.innerHeight):F&&f.isDef(F.clientWidth)?(C=F.clientWidth,E=F.clientHeight,0===C&&0<F.offsetWidth&&(C=F.offsetWidth),0===E&&0<F.offsetHeight&&(E=F.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(C=a.frameElement.clientWidth,E=a.frameElement.clientHeight);n=C;s.height=E;s.width=n}catch(G){m.getAggregator().trigger("error",k.ERROR_CODES.GET_AD_DIMENSIONS)}return s};return{calcDims:function(){return new E(n())},
getClippedDims:function(){var a=n();return new E({scrX:a.scrX,scrY:a.scrY,width:a.iFrameClippingWidth,height:a.iFrameClippingHeight})}}},Gb=function(){return{createInstance:function(a,b,c){return u.isDomless()?new Vd:new Wd(a,b,c)}}},Wd=function(a,b,c){var d,e=m.getAggregator().request("browser"),h=l&&l.contextNode&&l.contextNode.parentNode?l.contextNode.parentNode:null,r=Dd(b,c),n=function(){var a,b,k;d=d||Md(u,c);a=d.find();!a&&d.usePlaceholder?(q(),u.isDeviceTypeGroupMobile()&&e.hasMutationObserver()&&
p.getMutationObserver(s).observe(h,{childList:!0})):a&&(a=f(a).isArray()?a:[a],b=d.getAdContainer(),k=d.allowForAdContainerChange,f(a).each(function(a,c){r.addAdComponent(c,f.resolve(d.detectionMethod),b,k)}))},q=function(){var a;r.hasAd()||(a=t.getPlaceholderSpan(),h.insertBefore(a,l.contextNode.nextSibling),r.addAdComponent(a,k.DETECTION_METHODS.AD_PLACEHOLDER,t.getParent(a)))},s=function(a,b){var c=!1;f(a).each(function(a,b){b.addedNodes&&0<b.addedNodes.length&&(c=!0)});c&&(m.getAggregator().trigger("nodesAdded"),
b.disconnect())};Ed(a);return{find:function(){r.isUsingPlaceholder()||!r.hasAd()?n():r.refresh();return r},getDetectionMethod:function(){}}},Vd=function(){var a=function(){return null};return{find:a,getDetectionMethod:a}},pb=function(a){var b,c=[],d=a||x,e=function(){return"stub"===k().mode};a=function(){e()&&(b=d.setInterval(function(){if("stub"!==k().mode){d.clearInterval(b);for(var a=0;a<c.length;a++)d.avid.addEventListener(c[a].type,c[a].functionToExecute)}},10))};var f=function(){return void 0!==
d.avid},k=function(){var a,b={};if(f())if(a=d.avid.getAvidAdSessionContext(),"string"===typeof a)try{b=JSON.parse(a)}catch(c){__IntegralASDiagnosticCall("avidadsessioncontext",c,x.bootstrapper)}else"object"===typeof a&&(b=a);return b};u.isDomless()||a();return{isAvidAvailable:f,getAvidAdSessionContext:k,addEventListener:function(a,b){e()?c.push({type:a,functionToExecute:b}):d.avid.addEventListener(a,b)},getHtmlVideoAvidAdSessionListener:function(){if(e())throw"`HtmlVideoAvidAdSessionListener` is not available while in stub mode.";
return d.avid.getHtmlVideoAvidAdSessionListener()}}},ob=function(a){var b=new Xd,c=new Yd,d="undefined"!==typeof navigator?navigator.userAgent.toLowerCase():"";(function(){var e="",f=m.getAggregator().request("omidAdSessionContext"),l=u.isDomless()||f&&"app"===f.environment,f=f&&"web"===f.environment;try{var n;if(!(n=l)){var q;if(!(q=u.isAvid())){var s;if(!(s=u.isAvidNative())){var p;if(p=!f){var t;if(t=a.bootstrapOn("mobOrTab")){var w;if(w=a.bootstrapOn("mobAppWebview")){var l="FBAN FBAV Twitter Instagram Flipboard Snapchat LinkedInApp Pinterest".split(" "),
v,f=!1;for(v=0;v<l.length;v++)if(-1<d.indexOf(l[v].toLowerCase())){f=!0;break}w=!f}t=w}p=t}s=p}q=s}n=q}if(n&&(e=b.detect(),b.hasDetectedMobileApp())){if("s_serv"===e||"r_cars"===e)ka[ka.length-1].detectionRules.userAgent[0]="/";c.detect();m.getAggregator().trigger("addOutputItem",{output:"1"},"mapp",{type:"impression"});m.getAggregator().trigger("addOutputItem",{output:e},"drul",{type:"impression"})}}catch(x){m.getAggregator().trigger("error",k.ERROR_CODES.MOBILE_APP)}})();return{isMobileAppEnvironment:function(){return b.hasDetectedMobileApp()},
...
Ad=function(a,b){var c={mbrd:!1,mbvs:[],mbe:"n",mbv:9,mbs:[],mbm:1,mbivs:[]},d=function(a,b){var c=[],d=a.geometry.value();f(b).each(function(b,e){if(a.geometry.doesIntersect(e)){var f=e.value(),h=Math.max(d.leftX,f.leftX),k=Math.min(d.rightX,f.rightX),l=Math.max(d.topY,f.topY),f=Math.min(d.bottomY,f.bottomY);c.push(new V(h,k,l,f))}});return c},e=function(a,b){var c=0,e=d(a,b),h;f(e).each(function(a,b){h=b.value();c+=h.area});return c},h=function(){var b=0;c.mbs=[];f(a).each(function(a,d){c.mbs.push(d.isInView);
d.isInView&&(b+=d.percentageInViewContribution)});return b};b.addListener(function(b){f(a).each(function(a,c){c.isInView=e(c,b)>=c.geometry.value().area})});return{getPercentInView:function(){var a=h();c.mbrd=1;a!==c.mbp&&c.mbivs.push([u.getTagTime(),a]);return c.mbp=a},removePixels:function(){void 0!==b&&b.stop()},getPixelStateForDebug:function(){c.mbm=1;c.mbpr=[];c.mbir=[];f(a).each(function(a,b){c.mbpr.push(k.NA);c.mbir.push(!1)});return c},isReadyToMeasure:function(){return!0},getSliceStatus:function(){var b=
[];f(a).each(function(a,c){b.push(c.isInView)});return b}}},Bd=function(a){var b=T();return{getSliceStatus:function(c,d,e,f){var k,l=[];k=c.getRounded();c=k.height;var m=k.scrY,s=new E({scrX:k.scrX,width:k.width}),t=b.getConfig(k).numberOfSlices;s.set("height",p.floor(c/t));for(var u=0;u<t;u++)s.set("scrY",p.ceil(m+c/t*u)),k=100===a.calcPercentInView(s,d,e,f),l.push(k);return l}}},V=function(a,b,c,d){var e=Math.ceil(a),f=Math.ceil(b),k=Math.ceil(c),l=Math.ceil(d),m=f-e,s=l-k,p=m*s,t=function(){return{leftX:e,
rightX:f,topY:k,bottomY:l,width:m,height:s,area:p}};return{value:t,doesIntersect:function(a){var b=t();a=a.value();return a.leftX<b.rightX&&a.rightX>b.leftX&&a.topY<b.bottomY&&a.bottomY>b.topY}}},yd=function(){return{createInstance:function(a,b){return new IntersectionObserver(a,b)}}},zd=function(a,b){var c,d=[],e=[],h=function(){f(d).each(function(a,b){b(e)})},k=function(){var a=[];f(e).each(function(b,c){var d=c.value(),e=a,f=d.topY;-1===e.indexOf(f)&&e.push(f);e=a;d=d.bottomY;-1===e.indexOf(d)&&
...
a,e="getIasVidBridgeVersion"+a,h,r,n,q=[],s=k.OUT_OF_VIEW,t=!1,B=!1,w=!1,v=!0,x=new de,A=ee(),D=new be,C=new Qa,E=new Fa,G=function(b){var d;t=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=x.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(B=!0,s=w?k.IN_VIEW:!1):d.indicatesNotPlaying()?(B=!1,s=k.OUT_OF_VIEW):d.indicatesFullscreen()?(w=!0,s=B?k.IN_VIEW:k.OUT_OF_VIEW):d.indicatesNormalSize()&&(w=!1,s=B?!1:k.OUT_OF_VIEW),b=parseFloat(d.getVolume(C)),0<b?
v=!0:0===b&&(v=!1));q.push(d);n&&K();return d},F=function(b){var c,h,k=ma().wrapToGlobal(G),n=function(a){f.isStr(a)&&(m.getAggregator().provide("vc",function(){return a}),m.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{h=b[e]||b.getIasVidBridgeVersion,c=f.isFunction(h)&&"2"===h.call(b)?unescape(b[d].call(b,a,k)):unescape(b[d].call(b,a)),t=!0,n(c||"n")}catch(s){__IntegralASDiagnosticCall("handshakefailure",s,l)}},I=function(){var c=function(a){return f(f(a).toArray()).findFirst(function(a,
...
videoTranslator:function(){return r=r||new fe},adNode:H});H();D.listenForResult();A.isApplicable(u)&&A.start(c)})();return{findAdNode:H,getViewStateOverride:function(){return s},isHandshakeComplete:function(){return t},triggerInitializationEvents:K,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===k.NA;a.isVideoPlaying=!0;a.isSoundOn=v;a.isVideoPlayingInFullscreen=!1;if(s){if(s===k.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=k.OUT_OF_VIEW_REASONS.VIDEO;a.reason=
c.join(".")}a.viewState=b?a.viewState:s;a.isVideoPlaying=s===k.IN_VIEW}w&&B&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},ge=function(){return new $(k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,k.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},Tb=function(){var a,b,c={},d=0,e=function(c){if(c||a)d+=5,b.onTick(d,function(){a?e():m.getAggregator().trigger("sendDt",k.DT_CODES.PERFORMANCE)}),a=!1},h=function(){b=new Ca;d=0;e(!0);b.start()},l=function(d,e,k,l){d=c[d];l?(f.isDef(d[e])||
...
t-p.length,F+=oe(K,"adsafe_jsinfo=",a,b,c,e,f,r)}catch(P){a.add(k.ERROR_CODES.JSINFO),F+="adsafe_jsinfo=e:"+a.toString()}p=q+F;d.macroUrl&&(p+="&"===p.slice(-1)?"":"&",p+=d.macroUrl);s=p;d.sendImpression(s);l.impUrl=s;m.getAggregator().trigger("impressionsent")}catch(O){__IntegralASDiagnosticCall("impsend",O,l)}}}},oe=function(a,b,c,d,e,h,r,n){return function(c){var d=c.primary.join(","),h=b,k=0,l=function(a){if(a)return","+a};h.length+d.length+5<=a&&(h+=l(d),e.impressionIsIdentifiable(!0),f(c.secondary).each(function(b,
...
b.bundleIdentifier),t.push("apn:"+b.partner),t.push("apv:"+b.partnerVersion));a=pe(a,c,d,e,h,r,n);m.getAggregator().trigger("eligiblerender");return{primary:t,secondary:a}}())},pe=function(a,b,c,d,e,h,r){var n=[],q=m.getAggregator().request("mPage");n.push("mn:"+l.mn);n.push("pt:"+function(){var b=r.stringifyPingTimes();a.viewState!==k.NA&&(b+=a.details);return b}());n.push(f(h.params()).toParams());c.on("mrcAudit")&&!u.isDomless()&&n.push("dvs:"+p.getDoc().visibilityState);e.iterate(function(a,b){var c=
!b.props||f.isUndef(b.props.type),d=!b.props||b.props.type===k.IMPRESSION_EVENT;(c||d)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+l.mode);n.push("thd:"+f.stringifyTriState(q.supportsVisAPI()));n.push("et:"+(p.now()-l.birthdate));l.perf.mark("si");c.on("swapids")?n.push("oid:"+l.oid):n.push("uid:"+d.unq);n.push("v:19.8.130");n.push("sp:"+(l.isSplitMode?1:0));n.push("fwm:"+("true"===l.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(t.windowSize()).toArray().join(".")),
